/*
    rcc.h
    Reset and Clock Control (RCC) register map for STM32F446RE
    BASE ADDRESS: 0x40023800
    Reference: STM32F446RE Reference Manual RM0390, Section 6
*/
#ifndef RCC_H
#define RCC_H
...
// Each Register is 32 bits wide, reserved fields maintain correct offsets
typedef struct {
